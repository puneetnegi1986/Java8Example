...
public class ForkJoinFolderProcessor extends RecursiveTask<List<String>> {
	   ...
	   public  ForkJoinFolderProcessor(String path, String extension)
	   {
	      this.path = path;
	   ...
	   protected List<String> compute()
	   {
	      ...
	      if (content != null)
	      {
	         for (int i = 0; i < content.length; i++)
	         {
	            ...
	            {
	            	ForkJoinFolderProcessor task = new ForkJoinFolderProcessor(content[i].getAbsolutePath(), extension);
	               task.fork();
	               tasks.add(task);
	            }
	   ...
	   private void addResultsFromTasks(List<String> list, List<ForkJoinFolderProcessor> tasks)
	   {
	      for (ForkJoinFolderProcessor item : tasks)
	      {
	   ...
	   public static void main(String[] args)
	   {
	      ...
	      ForkJoinFolderProcessor system = new ForkJoinFolderProcessor("C:\\Windows", "log");
	      ForkJoinFolderProcessor apps = new ForkJoinFolderProcessor("C:\\Program Files", "log");
	      ForkJoinFolderProcessor documents = new ForkJoinFolderProcessor("C:\\Documents And Settings", "log");
