...
public class ForkJoinFolderProcessor extends RecursiveTask<List<String>> {
	...
	public static void main(String[] args) {
		...
		// ForkJoinFolderProcessor apps = new ForkJoinFolderProcessor("C:\\Program
		// Files", "log");
		// ForkJoinFolderProcessor documents = new
		// ForkJoinFolderProcessor("C:\\Documents And Settings", "log");
